...
- [ ] **Article + content question (읽는 걸 확실히 하기 위해 틀리면 되돌려보내기, 맞을 때까지 풀게하기, 찍는 걸 방지하기 위해 주관식)**
...
- [ ] **Remove pre-survey questions about gold task**
   - `db/seeds.rb`에서 기존 `Surveytask.create` 부분의 gold task들 삭제
- [ ] **Alternatively, general/singular causal claim 설명 붙이기**
   - `partials/_task.html.erb`에서 if문으로 task_id 체크 후 설명 보여주기 
- [ ] **Fake message about contribution to the modelUser will see “you can contribute to (5%) of confidence of this claim’s veracity by answering this question.”**
...
- [ ] **Post-survey question: “Why are you leaving” + (1 or more questions answered) “What makes you to contribute” + “AI랑 일했다고 생각하니?”**
   - `db/seeds.rb`에서 `Surveytask.create` 부분에 새로운 content questions를 넣기 (맨앞에 넣기)
